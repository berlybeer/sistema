  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if($_SESSION['almacen']==1){
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="categoria.php"><i class="fa fa-circle-o"></i> Catehorías</a></li>
          </ul>
        </li>';
        } ?>
      ...
      <?php if($_SESSION['acceso']==1){
          echo '<li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>Acceso</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
      ...
      <?php if($_SESSION['consultac']==1){
          echo '<li class="treeview">
          <a href="#">
            <i class="fa fa-calendar"></i> <span>Consulta Compras</span>
            <span class="pull-right-container">
      ...
      <?php if($_SESSION['consultav']==1){
          echo '<li class="treeview">
          <a href="#">
            <i class="fa fa-envelope"></i> <span>Consulta Ventas</span>
            <span class="pull-right-container">
