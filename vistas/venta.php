          ...
          <div class="box">
                   ...
                   <div class="panel-body"  id="formularioregistros">
                      <form method="POST" action="" name="formulario" id="formulario">
                        ...
                        <div class="form-group col-lg-3 col-md-3 col-md-offset-6 col-sm-6 col-xs-12">
                          <a data-toggle="modal" href="#myModal">
                            <button id="btnAgregarArt" type="button" class="btn btn-primary">
                              <span class="fa fa-plus">Agregar artículos</span>
                            </button>
                          </a>
                        </div>
                          ...
                          <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <button id="btnAgregarArt" type="button" class="btn btn-info" data-toggle="modal" data-target="#miventana">
                              <span class="fa fa-plus">Agregar artículos</span>
                            </button>
      ...
      <div class="modal-dialog" style="width: 65% !important;">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <table id="tblarticulos" class="table table-striped table-borderd table-condensed table-hover">
              <thead>
                <th>Opciones</th>
                <th>Nombre</th>
                <th>Categoría</th>
